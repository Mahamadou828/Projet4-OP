        ...
        function setUpSpecialNavs() {
            $(".navbar-toggle").click(function (t) {
              var e,
                ...
                l,
                n = $(this).closest("nav"),
                s = n.find("ul.site-navigation"),
                c = s.clone();
              s.parent().hasClass("nav-special") &&
                (t.stopPropagation(),
                $(this).hasClass("selected-nav")
                  ...
                  : ($(this).addClass("selected-nav"),
                    (e = n.attr("class").replace("navbar", "").replace("row", "")),
                    (a = s
                      .parent()
                      .attr("class")
                    ...
                    $(".blocsapp-special-menu blocsnav li").each(function () {
                      $(this).parent().hasClass("dropdown-menu")
                        ...
                        : ((o += l),
                          $(this)
                            .attr("style", "animation-delay:" + o + "ms")
                            .addClass("animated " + i));
                    }),
                    setTimeout(function () {
          ...
          function inViewCheck() {
            $($(".hideMe").get().reverse()).each(function (t) {
              ...
              a.height() > $(window).height() && (i = a.offset().top),
                i < o &&
                  ((e = a.attr("class").replace("hideMe", "animated")),
          ...
          function setUpVisibilityToggle() {
            $(document).on("click", "[data-toggle-visibility]", function (t) {
              t.preventDefault();
              var e,
                a = $(this).attr("data-toggle-visibility");
              function i(t) {
            ...
            window.targetLightbox,
              $(document)
                .on("click", "[data-lightbox]", function (t) {
                  ...
                  1 == a && (n = "autoplay");
                  var s = $(
                    '<div id="lightbox-modal" class="modal fade"><div class="modal-dialog modal-dialog-centered"><div class="modal-content ' +
                      l +
                      ' blocs-lb-container"><button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><div class="modal-body text-center"><a href="#" class="prev-lightbox" aria-label="prev"><span class="fa fa-chevron-left"></span></a><a href="#" class="next-lightbox" aria-label="next"><span class="fa fa-chevron-right"></span></a><img id="lightbox-image" class="img-thumbnail" src="' +
                      e +
              ...
              $(document).on("click", ".next-lightbox, .prev-lightbox", function (t) {
                ...
                ".mp4" == l.substring(l.length - 4)
                  ? ((o = ""),
                    1 == i.attr("data-autoplay") && (o = "autoplay"),
                    $("#lightbox-image, .lightbox-caption").hide(),
                  ...
                  : ($("#lightbox-image").attr("src", l).show(),
                    $(".lightbox-caption").html(i.attr("data-caption")).show(),
                    $("#lightbox-video-container").hide()),
                  (targetLightbox = i),
                  ...
                  "no-gallery-set" == e
                    ? ($("a[data-lightbox]").index(i) !=
                      ...
                      0 < $("a[data-lightbox]").index(i) && $(".prev-lightbox").show())
                    : ($('a[data-gallery-id="' + e + '"]').index(i) !=
                        $('a[data-gallery-id="' + e + '"]').length - 1 &&
                        $(".next-lightbox").show(),
                      0 < $('a[data-gallery-id="' + e + '"]').index(i) &&
                        $(".prev-lightbox").show());
              });
          }
